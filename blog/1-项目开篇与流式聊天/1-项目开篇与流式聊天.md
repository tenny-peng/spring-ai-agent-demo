...
> IDEA 本地预览看不到图片是博客园防盗链所致，发布到博客园后正常显示。

![初始对话页面](./images/spring ai alibaba agent 1 初始对话页面.png)

![对话回复效果](./images/spring ai alibaba agent 1 对话回复效果.PNG)

![Postman 流式响应效果](./images/spring ai alibaba agent 1 postman对话效果.png)
